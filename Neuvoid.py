...
class NeuroVoidApp: def init(self, root): self.root = root self.root.title("NeuroVoid") self.root.geometry("600x400") self.root.configure(bg='black')
...
if name == "main": root = tk.Tk() app = NeuroVoidApp(root) root.mainloop()
